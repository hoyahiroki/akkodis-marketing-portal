...
def build_top():
    blocks = [
        ...
        quicklinks(
            [("業務依頼フォーム", "ブランド以外の依頼はこちら"), ("ブランドレビューの手順", "ブランド関連はこちら")],
...
def build_brand_part2():
    blocks = [
        ...
        steps(
            "「ロゴ掲載申請」セクション",
            ["Marketing部依頼フォームから申請", "Marketing部からTeams連絡を受ける",
             "Salesforceのサービスリクエストから押印申請", "掲載許諾依頼書とロゴデータを回収",
             "PDF化してMarketing部へ送付", "HP掲載"],
